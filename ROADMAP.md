...
- **#7 progress.** Commit 1/5 `d35c68a` (design note + ROADMAP flip). Commit 2/5 in progress: `scoring/costs.py` pure-math module + 40 unit tests — green locally (259 total). Remaining: backtest hook (3/5), paper-log + HTML hook (4/5), pipeline wiring (5/5).
